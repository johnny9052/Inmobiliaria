...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2018 a las 17:03:40
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listpropertiecsv` (`vid` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `saveclientpublic` (`vid` INT, `vFirstName` VARCHAR(20), `vSecondName` VARCHAR(20), `vFirstLastName` VARCHAR(20), `vSecondLastName` VARCHAR(20), `vMobilePhone` VARCHAR(10), `vEmail` VARCHAR(45), `vPassword` VARCHAR(10)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`root`@`localhost` FUNCTION `savecontractpropertie` (`vid` INT, `vclient` INT, `vpropertie` INT, `vfirmDate` VARCHAR(50), `vstartDate` VARCHAR(50), `vendDate` VARCHAR(50), `vcontractValue` FLOAT, `vtermContract` INT, `vwayPay` VARCHAR(50), `vurlContract` VARCHAR(500)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
(2, 44564532, 'Victor', 'Hugo', 'Garcia', 'Quintero', 'El cortijo', '7465432', '3219087766', 'victorgarcia@gmail.com', '2018-09-05', 886, 16, 886, 4593, 11, 44, 13, NULL),
...
(1, 1094882984, 'David', 'Alberto', 'Angarita', 'Garcia', 'Calle 5 Norte', '7456322', 'Av. Bolivar # 3-11', '7456342', '3002680564', 'davidangaritag@gmail.com', 3000000, '4', 16, 886, 886, '0000-00-00');
...
(28, 'System/Resource/Images/Properties/123456789_desert.jpg', 4),
(27, 'System/Resource/Images/Properties/123456789_hydrangeas.jpg', 4),
(29, 'System/Resource/Images/Properties/123456789_chrysanthemum.jpg', 4),
(30, 'System/Resource/Images/Properties/987654321_jellyfish.jpg', 5),
(31, 'System/Resource/Images/Properties/987654321_koala.jpg', 5),
(32, 'System/Resource/Images/Properties/987654321_lighthouse.jpg', 5),
(33, 'System/Resource/Images/Properties/454545454_img20170919wa0003.jpg', 6),
(34, 'System/Resource/Images/Properties/454545454_img20170919wa0005.jpg', 6);
...
(4, 100000000, 200000, 3, 2, 2, 200, 190, '2018', '14', 0, 0, 1, 0, 0, 0, 0, 1, 1, '4.547359782956471', '-75.66334115587523', 1, 1, 1, 1, 0, 0, 1, 1, 0, 886, 34, 32, 16, 12, 21, 46, 12, 1501, 21, 16, 12, 72, 1, '2018-09-08', '2018-09-01', 16, 'Descripción inmueble', '123456789', 90000000, 0, 0, 1, 0),
(5, 200000000, 300000, 4, 2, 2, 300, 280, '2018', '1', 1, 1, 1, 1, 0, 0, 0, 1, 0, '4.547455209982011', '-75.6641847050879', 0, 1, 0, 0, 1, 1, 0, 0, 0, 886, 35, 31, 16, 12, 21, 46, 12, 1403, 21, 18, 11, 71, 3, '2018-09-17', '2018-08-29', 18, 'Descripción', '987654321', 88000000, 0, 1, 1, 0),
(6, 1000000, 125000, 3, 2, 1, 78, 70, '2017', '5', 1, 0, 1, 0, 1, 0, 1, 0, 1, '4.550400272476861', '-75.66232143349214', 0, 0, 1, 1, 1, 1, 0, 0, 1, 886, 34, 32, 15, 11, 23, 48, 12, 1555, 21, 18, 12, 81, 2, '2018-09-20', '2018-09-03', 16, 'Descripción inmueble', '454545454', 99000000, 1, 0, 0, 0);
...
(9, 'https://www.youtube.com/watch?v=m9kyBfpHeck&t=111s', 5),
(8, 'https://www.youtube.com/watch?v=6RHVcUECeJI', 4),
(10, 'https://www.youtube.com/watch?v=hslg-poUklo', 6);
...
--
ALTER TABLE `ciudades`
  MODIFY `idciudad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1126;
...
--
ALTER TABLE `departamentos`
  MODIFY `idDepartamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de la tabla `detalleclientestipoclientes`
--
ALTER TABLE `detalleclientestipoclientes`
  MODIFY `iddetalleClientesTipoClientes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `deudorsolidario`
  MODIFY `idDeudor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `estadocivil`
  MODIFY `idEstadoCivil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `imageninmueble`
  MODIFY `idImagenInmueble` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `nivelprofesion`
  MODIFY `idnivelProfesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `paises`
  MODIFY `idpais` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
...
--
ALTER TABLE `tipoidentificacion`
  MODIFY `idtipoIdentificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `tipopersonacliente`
--
ALTER TABLE `tipopersonacliente`
  MODIFY `idtipoPersonCliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `tipopqrs`
--
ALTER TABLE `tipopqrs`
  MODIFY `idtipopqrs` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `videoinmueble`
  MODIFY `idVideoInmueble` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `pqrs`
  ADD CONSTRAINT `fk_idtipopqrs` FOREIGN KEY (`idtipopqrs`) REFERENCES `pqrs` (`idPQRS`) ON DELETE NO ACTION ON UPDATE NO ACTION;
