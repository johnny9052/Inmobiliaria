...
/* IMPORTS */
require '../../DTO/Client/ProfileClientDTO.php';
require '../../DAO/Client/ProfileClientDAO.php';
...
$obj = new ProfileClientDTO($id, $firstName, $secondName, $firstLastName, $secondLastName, $documentType, $documentNumber, $cityExpedition, $birthdate, $clientType, $address, $homePhone, $mobilePhone, $email, $gender, $cityResidence, $profession, $maritalStatus, $personType, $typesClientSelecteds, $password);
$dao = new ProfileClientDAO();
